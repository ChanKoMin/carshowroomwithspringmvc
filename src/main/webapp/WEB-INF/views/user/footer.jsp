...
<footer class="p-5" style="background-color: #262626">
	<div class="row">
		<div class="col-6 d-flex flex-column align-items-center gap-2">
			...
			<small class="text-white-50">&copy; Copyright All Rights
				Reserved.</small>
		</div>
		<div class="col-3 m-auto">
			...
			<div>
				...
				<p class="text-white-50">chankomin225@gmail.com</p>
			</div>
		</div>
		<div class="col-3 m-auto">
			<h6 class="text-white-50">Address</h6>
			<p class="text-white-50">
				Pearl Yadana Vocational Training Center, <br /> Yangon Myanmar.
			</p>
			<br />
			<div>
				<p class="mb-0 text-white-50">
				...
				<p class="text-white-50">+959792213808</p>
			</div>
		</div>
	</div>
</footer>
