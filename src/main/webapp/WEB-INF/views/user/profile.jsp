					...
					<form action="${pageContext.request.contextPath}/update-profile"
						...
						<div class="row">
							...
							<div class="col-5">
								...
								<input type="file" name="image" class="form-control mt-4 w-75" />
							</div>
							<div class="col-5">
								<div class="">
									<input type="hidden" value="${user.id}" /> <label for="name"
										class="form-label">Name</label> <input type="text" name="name"
								...
								<div class="my-3">
									<label for="contact_number" class="form-label">Phone
										...
										name="contact_number" id="contact_number" class="form-control" />
								</div>
								<div class="">
