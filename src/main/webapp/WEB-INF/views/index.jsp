...
<div id="carouselExampleIndicators" class="carousel slide">
	...
	<div class="carousel-inner position-relative">
		...
		<p
			...
			Brands, Browse Extensive Inventory, and<br /> Drive Home Your Dream
			Car Today!"
		</p>
		<a href="#explore"
...
<div class="my-5 w-75 m-auto">
	...
	<div class="row my-5">
		...
		<c:if test="${fn:length(brands) > 8}">
			<div class="d-flex justify-content-center">
				<a class="cta" href="${pageContext.request.contextPath}/all-brands">
					<span>View More</span> <span><svg width="46px" height="25px"
							viewBox="0 0 66 43" version="1.1"
							xmlns="http://www.w3.org/2000/svg"
							xmlns:xlink="http://www.w3.org/1999/xlink">
        <g id="arrow" stroke="none" stroke-width="1" fill="none"
	...
	<div class="card pt-5 px-5 w-50 m-auto">
		...
		<div class="card-body">
			<form action="" method="post">
				...
				<div class="">
					...
					<div class="mb-3">
						<span onclick="giveFeedback(1)" class="star"><i
							class="bi bi-star star-size"></i></span> <span onclick="giveFeedback(2)"
							class="star ml"><i class="bi bi-star star-size"></i></span> <span
							onclick="giveFeedback(3)" class="star"><i
							class="bi bi-star star-size"></i></span> <span onclick="giveFeedback(4)"
							class="star"><i class="bi bi-star star-size"></i></span> <span
				...
				<button class="btn btn-primary mb-1 w-100">Submit Feedback</button>
			</form>
		</div>
	</div>
</div>
