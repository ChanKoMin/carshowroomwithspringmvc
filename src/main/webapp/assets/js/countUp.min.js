            ...
            (this.endVal = n),
                ...
                (this.count = function (t) {
                    ...
                    (a.remaining = a.duration - i),
                        a.useEasing
                            ? a.countDown
                                ? (a.frameVal = a.startVal - a.easingFn(i, 0, a.startVal - a.endVal, a.duration))
                                : (a.frameVal = a.easingFn(i, a.startVal, a.endVal - a.startVal, a.duration))
                            : (a.frameVal = a.startVal + (a.endVal - a.startVal) * (i / a.duration));
                    ...
                    (a.frameVal = n ? a.endVal : a.frameVal),
                        ...
                        i < a.duration ? (a.rAF = requestAnimationFrame(a.count)) : null !== a.finalEndVal ? a.update(a.finalEndVal) : a.options.onCompleteCallback && a.options.onCompleteCallback();
                }),
